    ...
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const createClientResponse = yield createCompanyUseCase(data);
...
const createCompanyUseCase = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const prisma = tsyringe_1.container.resolve("PrismaClient");
    const company = yield prisma.company.create(data);
    return {
        meta: {
            status: 200,
