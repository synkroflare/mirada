    ...
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const createClientResponse = yield listCompanyUseCase({ data });
...
const listCompanyUseCase = ({ data }) => __awaiter(void 0, void 0, void 0, function* () {
    const prisma = tsyringe_1.container.resolve("PrismaClient");
    const company = yield prisma.company.findMany(data);
    return {
        meta: {
            status: 200,
