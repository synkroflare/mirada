    ...
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const createClientResponse = yield createClientUseCase(data);
...
const createClientUseCase = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const prisma = tsyringe_1.container.resolve("PrismaClient");
    const client = yield prisma.client.create(data);
    return {
        meta: {
            status: 200,
