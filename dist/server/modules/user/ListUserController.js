    ...
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const createClientResponse = yield listUserUseCase({ id, data });
...
const listUserUseCase = ({ data }) => __awaiter(void 0, void 0, void 0, function* () {
    const prisma = tsyringe_1.container.resolve("PrismaClient");
    const users = yield prisma.user.findMany(data);
    return {
        meta: {
            status: 200,
